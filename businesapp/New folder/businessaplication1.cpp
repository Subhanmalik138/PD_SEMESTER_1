...
void loadMarksheet(string studentNames[], float marks[][number], string subjects[], int& studentCount, int& subjectCount);
void loadAttendance(string studentNames[], string attendance[][number], int& studentCount, int& attendanceCount);
void loadstaffprivacy(string staffUsername[], string staffPassword[], int& staffCount);
void loadstaffdetail(string tname[], string tfathername[], string tcinic[], string tphone[], int& staffCount);
void loadStudentDetail(string sname[], string sfathername[], string scinic[], string sphone[], int& studentCount);
void loadStudentPrivacy(string studentUsername[], string studentPassword[], int& studentCount);
// store function
void storeStaffPrivacy(string staffUsername[], string staffPassword[], int& staffCount);
void storeStaffDetail(string tname[], string tfathername[], string tcinic[], string tphone[], int& staffCount);
void storeStudentPrivacy(string studentUsername[], string studentPassword[], int& studentCount);
void storeStudentDetail(string sname[], string sfathername[], string scinic[], string sphone[], int& studentCount);
void saveAllData(string staffUsername[], string staffPassword[], string tname[], string tfathername[], string tcinic[], string tphone[], int staffCount, string studentUsername[], string studentPassword[], string sname[], string sfathername[], string scinic[], string sphone[], int studentCount);
void storeAttendance(string studentNames[], string attendance[][number], int studentCount, int attendanceCount);
void storeMarksheet(string studentNames[], float marks[][number], string subjects[], int studentCount, int subjectCount);
// print function 
void staffmenu();
void menu();
void princpalmenu();
...
int findteacherIndex(string str, string staffUsername[], int staffCount);
bool checkloginidentity(string inputUsername, string principalUsername, string principalPassword, string inputPassword, string& role, string staffUsername[], string staffPassword[], int staffCount, string studentUsername[], string studentPassword[], int studentCount);
bool validateCNIC(string cnic);
bool checkexistsoftecher(string username, string staffUsername[], int staffCount);

bool validatePhoneNumber(string phone);
bool isAlpha(char c);
bool isDigit(char c);

void clearMarks(int studentIndex, int subjectIndex, float marks[][number]);
bool validateUsername(string username);
bool validatePassword(string password);
bool isspecial(char c);
//working funtion
void teacher(string staffUsername[], string staffPassword[], string tname[number], string tfathername[], string tcinic[], string tphone[], int& staffCount, string teacherannouncement[], string announ, string studentUsername[], string studentPassword[], string sname[], string sfathername[], string scinic[], string sphone[], int& studentCount, string studentattendence[][number], int& attendencecunt, float marks[][number], int& markscount, string subject[10], int& subjectcount, string studentcompalin[], int complainount, string compalinaction[], int& complainactioncount, int& announcemnetcount);
void principal(string& principalUsername, string& principalPassword, string staffUsername[], string staffPassword[], string tname[], string tfathername[], string tcinic[], string tphone[], int& staffCount, string& announ, string studentUsername[], string studentPassword[], string sname[], string sfathername[], string scinic[], string sphone[], int& studentCount);

void student(string staffUsername[], string staffPassword[], string tname[number], string tfathername[], string tcinic[], string tphone[], int& staffCount, string teacherannouncement[], string announ, string studentUsername[], string studentPassword[], string sname[], string sfathername[], string scinic[], string sphone[], int& studentCount, string studentattendence[][number], int attendencecunt, float marks[][number], int markscount, string subject[10], int subjectcount, string studentcompalin[], int& complainount, string compalinaction[], int complainactioncount, int announcemnetcount);
//color codes
...
int main()
{
    ...
    string announ;
    //teacher variables
    string staffUsername[number];
    string staffPassword[number];
    string tname[number];
    string tfathername[number];
    string tcinic[number];
    string tphone[number];

    int staffCount = 0;
    loadstaffprivacy(staffUsername, staffPassword, staffCount);
    loadstaffdetail(tname, tfathername, tcinic, tphone, staffCount);
    ...
    //student variables
    string studentUsername[number];
    string studentPassword[number];
    string sname[number];
    string sfathername[number];
    string scinic[number];
    string sphone[number];
    int studentCount = 0;
    ...
    int complainount = 0;
    loadStudentPrivacy(studentUsername, studentPassword, studentCount);
    loadStudentDetail(sname, sfathername, scinic, sphone, studentCount);

    loadAttendance(sname, studentattendence, studentCount, attendencecunt);
    loadMarksheet(sname, marks, subject, studentCount, subjectcount);
    string compalinaction[number];
    int complainactioncount = 0;
    while (true)
    {
        ...
        if (option == "1") {
            ...
            string role;
            if (checkloginidentity(inputUsername, principalUsername, principalPassword, inputPassword, role, staffUsername, staffPassword, staffCount, studentUsername, studentPassword, studentCount)) {
                if (role == "principal") {
                    principal(principalUsername, principalPassword, staffUsername, staffPassword, tname, tfathername, tcinic, tphone, staffCount, announ, studentUsername, studentPassword, sname, sfathername, scinic, sphone, studentCount);
                }
                else if (role == "staff")
                {
                    teacher(staffUsername, staffPassword, tname, tfathername, tcinic, tphone, staffCount, teacherannouncement, announ, studentUsername, studentPassword, sname, sfathername, scinic, sphone, studentCount, studentattendence, attendencecunt, marks, markscount, subject, subjectcount, studentcompalin, complainount, compalinaction, complainactioncount, announcemnetcount);
                }
                else if (role == "student") {
                    student(staffUsername, staffPassword, tname, tfathername, tcinic, tphone, staffCount, teacherannouncement, announ, studentUsername, studentPassword, sname, sfathername, scinic, sphone, studentCount, studentattendence, attendencecunt, marks, markscount, subject, subjectcount, studentcompalin, complainount, compalinaction, complainactioncount, announcemnetcount);
                }
            }
            else {
                cout << r;
...
bool checkexistsofstudent(string username, string studentUsername[], int studentCount)
{
...
int findstudentIndex(string str, string studentUsername[], int studentCount)
{
                ...
                if (staffOption == "1") {
                    while (true) {
                        ...
                        while (true)
                        {
                            ...
                            if (checkexistsoftecher(username, staffUsername, staffCount))
                            {
                                cout << r;
                        ...
                        staffCount++;
                        saveAllData(staffUsername, staffPassword, tname, tfathername, tcinic, tphone, staffCount, studentUsername, studentPassword, sname, sfathername, scinic, sphone, studentCount);
                        cout << r;
                ...
                if (studentOption == "1") {
                    while (true) { // Keep asking until valid information is added
                        ...
                        while (true) { // Loop until a valid username is entered
                            ...
                            if (checkexistsofstudent(username, studentUsername, studentCount)) {
                                cout << r;
            ...
            while (true)
            {
                ...
                if (attendanceOption == "1") {
                    ...
                    if (studentCount != 0) {
                        ...
                        storeAttendance(sname, studentattendence, studentCount, attendencecunt);
                        cout << b;
            ...
            while (true)
            {
                ...
                if (marksOption == "1") {
                    ...
                    if (studentCount > 0) {
                        ...
                        cout << b;
                        storeMarksheet(sname, marks, subject, studentCount, subjectcount);
                    ...
                    if (studentCount > 0) {
                        ...
                        if (studentIndex >= 0 && studentIndex < studentCount) {
                            ...
                            if (subjectIndex >= 0 && subjectIndex < subjectcount) {
                                clearMarks(studentIndex, subjectIndex, marks);
                                cout << m;
        ...
        else if (option == "3")
        {
            while (true)
            {
                ...
                if (announcementOption == "1") {
                    ...
                    int index = findteacherIndex(username, staffUsername, staffCount);
                    if (index < 0) {
                        cout << r;
            ...
            while (true) {
                ...
                if (subOption == "1") { // Update username/password
                    while (true) {
                        ...
                        int number = findteacherIndex(username, staffUsername, staffCount);
                        if (number == -1) {
                        ...
                        while (true) {
                            ...
                            cout << b;
                            getline(cin, newUsername);
                            if (checkexistsoftecher(newUsername, staffUsername, staffCount)) {
                                cout << r;
                    ...
                    while (true) {
                        ...
                        cout << b;
                        getline(cin, name);
                        int number = findteacherIndex(name, staffUsername, staffCount);
                        if (number < 0) {
                            cout << r;
    ...
    while (true)
    {
        ...
        if (option == "1")
        {
            while (true) {
                ...
                int index = findstudentIndex(user, studentUsername, studentCount);
                system("cls");
                attendencemenu();
                cout << r;
            ...
            while (true)
            {
                ...
                if (subOption == "1") {
                    while (true) {
                        ...
                        int number = findstudentIndex(username, studentUsername, studentCount);
                        if (number == -1) {
                            cout << r;
                            cout << "USERNAME NOT FOUND!" << endl;
                            Sleep(1500);
                        ...
                        while (true) {
                            ...
                            if (checkexistsofstudent(newUsername, studentUsername, studentCount)) {
                                cout << r;
                ...
                else if (subOption == "2")
                {
                    ...
                    while (true) {
                        ...
                        int number = findstudentIndex(name, studentUsername, studentCount);
                        if (number < 0) {
                            cout << r;
                            cout << "NO SUCH PROFILE EXISTS!" << endl;
                            system("pause");
            ...
            while (true)
            {
                ...
                else if (suboption == "2")
                {
                    ...
                    if (announcemnetcount == 0) {
                        ...
                        cout << "ANNOUNCEMNT FROM TEACHERS ARE :" << endl;
                        for (int i = 0; i < announcemnetcount; i++)
                        {
                            cout << i + 1 << " :   " << endl << teacherannouncement[i] << endl;
                        }
                    }
                    cout << "--------------------------------------------\n";
                    system("pause");
...
void clearMarks(int studentIndex, int subjectIndex, float marks[][number])
{
    marks[studentIndex][subjectIndex] = -1;
}
void loadstaffprivacy(string staffUsername[], string staffPassword[], int& staffCount) {
    fstream fuser("stafflogin.txt", ios::in);

    if (!fuser.is_open()) {
        cerr << "Error: Could not open username or password file.";
        return;
    }

    string usernamed, passwored;
    int count = 0;

    while (getline(fuser, usernamed) && getline(fuser, passwored)) {
        if (count < number) {
            staffUsername[count] = usernamed;
            staffPassword[count] = passwored;
            count++;
        }
        else {
            break;
...
void loadstaffdetail(string tname[], string tfathername[], string tcinic[], string tphone[], int& staffCount) {
    fstream fdetail("staffdetail.txt", ios::in);

    if (!fdetail.is_open()) {
        cerr << "Error: Could not open staff detail file.";
        return;
    }

    string name, fathername, cnic, phone;
    int count = 0;

    while (getline(fdetail, name) && getline(fdetail, fathername) && getline(fdetail, cnic) && getline(fdetail, phone)) {
        if (count < number) {
            tname[count] = name;
            tfathername[count] = fathername;
            tcinic[count] = cnic;
            tphone[count] = phone;
            count++;
        }
    ...
    staffCount = count; // Update staffCount correctly
    fdetail.close();
}

void loadStudentPrivacy(string studentUsername[], string studentPassword[], int& studentCount) 
{
    fstream fuser("studentlogin.txt", ios::in);
    ...
    while (getline(fuser, usernamed) && getline(fuser, passwored)) {
        if (count < number) {
            studentUsername[count] = usernamed;
            studentPassword[count] = passwored;
            count++;
        }
        else {
            break;
...
void loadStudentDetail(string sname[], string sfathername[], string scinic[], string sphone[], int& studentCount) 
{
    fstream fdetail("studentdetail.txt", ios::in);

    if (!fdetail.is_open()) {
        cout << "Error: Could not open staff detail file.";
        return;
    }
...
void storeStaffPrivacy(string staffUsername[], string staffPassword[], int& staffCount) {
    fstream fuser("stafflogin.txt", ios::out);

    if (!fuser.is_open()) {
        cerr << "Error: Could not open staff login file for writing.\n";
        return;
    }

    for (int i = 0; i < staffCount; i++) {
        fuser << staffUsername[i] << endl;
        fuser << staffPassword[i] << endl;
    }
...
void storeStaffDetail(string tname[], string tfathername[], string tcinic[], string tphone[], int& staffCount) {
    fstream fdetail("staffdetail.txt", ios::out);

    if (!fdetail.is_open()) {
        cerr << "Error: Could not open staff detail file for writing.\n";
        return;
    }

    for (int i = 0; i < staffCount; i++) {
        fdetail << tname[i] << endl;
        fdetail << tfathername[i] << endl;
        fdetail << tcinic[i] << endl;
        fdetail << tphone[i] << endl;
    }
...
void storeStudentPrivacy(string studentUsername[], string studentPassword[], int& studentCount) {
    fstream fuser("studentlogin.txt", ios::out);

    if (!fuser.is_open()) {
        cerr << "Error: Could not open student login file for writing.\n";
        return;
    }

    for (int i = 0; i < studentCount; i++) {
        fuser << studentUsername[i] << endl;
        fuser << studentPassword[i] << endl;
    }
...
void storeStudentDetail(string sname[], string sfathername[], string scinic[], string sphone[], int& studentCount) {
    fstream fdetail("studentdetail.txt", ios::out);

    if (!fdetail.is_open()) {
        cerr << "Error: Could not open student detail file for writing.\n";
        return;
    }

    for (int i = 0; i < studentCount; i++) {
        fdetail << sname[i] << endl;
        fdetail << sfathername[i] << endl;
        fdetail << scinic[i] << endl;
        fdetail << sphone[i] << endl;
    }
...
void saveAllData(string staffUsername[], string staffPassword[], string tname[], string tfathername[], string tcinic[], string tphone[], int staffCount, string studentUsername[], string studentPassword[], string sname[], string sfathername[], string scinic[], string sphone[], int studentCount) {
    storeStaffPrivacy(staffUsername, staffPassword, staffCount);
    storeStaffDetail(tname, tfathername, tcinic, tphone, staffCount);
    storeStudentPrivacy(studentUsername, studentPassword, studentCount);
    storeStudentDetail(sname, sfathername, scinic, sphone, studentCount);
}
void storeAttendance(string studentNames[], string attendance[][number], int studentCount, int attendanceCount)
{
    ofstream file("attandence.txt"); // Open the file for writing
    ...
    // Write each student's name and their attendance
    for (int i = 0; i < studentCount; ++i) {
        file << studentNames[i]; // Write the student's name
        for (int j = 0; j < attendanceCount; ++j) {
            file << " " << attendance[i][j]; // Write their attendance
        }
...
void loadAttendance(string studentNames[], string attendance[][number], int& studentCount, int& attendanceCount)
{
    ifstream file("attandence.txt"); // Open the file for reading
    ...
    studentCount = 0;
    attendanceCount = 0; // Reset attendance count
    ...
    while (file) {
        ...
        studentNames[studentCount] = line.substr(0, pos); // Extract the student's name
        string record = line.substr(pos + 1); // Extract the attendance record

        int dayCount = 0;
        size_t start = 0, end;
        while ((end = record.find(' ', start)) != string::npos) {
            attendance[studentCount][dayCount] = record.substr(start, end - start); // Extract attendance
            start = end + 1;
            dayCount++;
        }
        attendance[studentCount][dayCount] = record.substr(start); // Add the last attendance value
        dayCount++;

        attendanceCount = max(attendanceCount, dayCount); // Update attendanceCount
        studentCount++;
    }

    file.close();
    cout << "Attendance loaded from file successfully.\n";
}

void loadMarksheet(string studentNames[], float marks[][number], string subjects[], int& studentCount, int& subjectCount)
{
    ifstream file("marksheet.txt"); // Open the file for reading

    if (!file.is_open()) {
        cout << "Error: Could not open the marksheet file." << endl;
        return;
    }
    ...
    while (getline(file, line)) { // Read the file line by line
        ...
        if (spacePos == string::npos) continue; // Skip invalid lines

        // Extract the student's name
        studentNames[studentCount] = line.substr(0, spacePos);

        // Extract the marks data (everything after the student's name)
        string marksData = line.substr(spacePos + 1);
        int col = 0;

        // Parse the marks data
        size_t start = 0, end;
        while ((end = marksData.find(' ', start)) != string::npos) {
            string subjectMark = marksData.substr(start, end - start);
            size_t colonPos = subjectMark.find(':');

            if (colonPos != string::npos) {
                // Extract the subject name and mark
                string subject = subjectMark.substr(0, colonPos);
                float mark = stof(subjectMark.substr(colonPos + 1));
                ...
                // If the subject is new, add it to the subjects array
                if (subjectIndex == -1) {
                    subjectIndex = subjectCount;
                    subjects[subjectCount++] = subject;
                }

                // Store the mark in the marks array
                marks[studentCount][subjectIndex] = mark;
            }

            start = end + 1;
        }

        studentCount++; // Move to the next student
    }

    file.close(); // Close the file
    cout << "Marksheet loaded successfully!" << endl;
}
void storeMarksheet(string studentNames[], float marks[][number], string subjects[], int studentCount, int subjectCount)
{
    ofstream file("marksheet.txt");

    if (!file.is_open()) {
        cerr << "Error: Could not open the marksheet file for writing." << endl;
        return;
    }

    for (int i = 0; i < studentCount; ++i) {
        file << studentNames[i]; // Write student name
        for (int j = 0; j < subjectCount; ++j) {
            file << " " << subjects[j] << ":" << marks[i][j]; // Write subject and marks
        }
        file << endl; // New line after each student's marks
    }

    file.close();
    cout << "Marksheet stored successfully!" << endl;
}
